import * as diff from '../diff/apply';
...
describe('Apply Patch', () => {
  ...
  it('Functional test', () => {
    function add(oldPos: number, newPos: number, str: string): diff.ApplyItem<string> {
      return {
        type: 'add',
        oldPos,
        newPos,
    ...
    function remove(oldPos: number, newPos: number, str: string): diff.ApplyItem<string> {
      return {
        type: 'remove',
        oldPos,
        newPos,
    ...
    function apply_str(a: string, b: string, script: diff.Apply<string>, msg?: string) {
      assert.deepStrictEqual(diff.applyPatch(a.split(''), script), b.split(''), msg);
    }
